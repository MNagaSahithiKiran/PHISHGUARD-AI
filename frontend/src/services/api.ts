...
export const getApiBaseUrl = (): string => {
  // 1. Explicit environment variable: VITE_API_BASE_URL takes primary precedence, then VITE_API_URL
  ...
  // 2. In production mode (e.g. Vercel deployment), NEVER silently fall back to localhost
  if (import.meta.env.PROD) {
    return '';
  }

  // 3. Browser window origin detection for local dev
